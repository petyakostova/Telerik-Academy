namespace Konspiration_AS
{
    using System;
    using System.Collections.Generic; // List<string>
    using System.Text; // StringBuilder()

    class KonspirationAS
    {
        /* taken from https://msdn.microsoft.com/en-us/library/x53a06bb.aspx 
           remove all known keywords which can invoke methods (primitive data types) - example int.Parse */
