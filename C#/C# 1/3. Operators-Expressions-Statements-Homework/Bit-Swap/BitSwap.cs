...
class BitSwap
{
    static void Main()
    {
        ...
        else
        {
            ...
            //get the bits at position p, p+1, ..., p+k-1 and put them in pArray
            ...
            //get the bits at position q, q+1, ..., q+k-1 and put them in qArray
            ...
            // exchange the bits at position p, p+1, ..., p+k-1
            for (int position = p; position < p + k; position++)   
            {
            ...
            // exchange the bits at position q, q+1, ..., q+k-1
            for (int position = q; position < q + k; position++)    
            {
