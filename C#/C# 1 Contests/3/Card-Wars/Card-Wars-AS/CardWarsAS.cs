    ...
    public static void Main()
    {
        ...
        for (int i = 0; i < numberOfGames; i++)
        {
            ...
            for (int j = 0; j < 3; j++)
            {
                ...
                switch (firstPlayerCard)
                {
                    ...
                    case "Y":
                        ...
                        break;
                    case "X":
                        theXCardDrawnByFirstPlayer = true;
                        break;
                    default:
                        firstPlayerHandStrength += 12 - int.Parse(firstPlayerCard);
                        break;
                }
            }
            ...
            for (int j = 0; j < 3; j++)
            {
                ...
                {
                    case "A":
                        secondPlayerHandStrength += 1;
                        break;
                    case "J":
                        secondPlayerHandStrength += 11;
                        break;
                    case "Q":
                        secondPlayerHandStrength += 12;
                        break;
                    case "K":
                        secondPlayerHandStrength += 13;
                        break;
                    case "Z":
                        secondPlayerScore *= 2;
                        break;
                    case "Y":
                        ...
                        break;
                    case "X":
                        theXCardDrawnBySecondPlayer = true;
                        break;
                    default:
                        secondPlayerHandStrength += 12 - int.Parse(secondPlayerCard);
                        break;
                }
            }
