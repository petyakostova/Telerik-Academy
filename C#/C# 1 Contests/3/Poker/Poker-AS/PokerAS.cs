...
//for (int i = 1; i <= 13; i++)
//{
//    if (i == 13) Console.Write("c{0} == 2", i);
//    else Console.Write("c{0} == 2 || ", i);
//}
//Console.WriteLine(")");
...
//    for (int j = i; j < i + 5; j++)
//    {
//        if (j == i) Console.Write("c{0} == 1", j == 14 ? 1 : j);
//        else Console.Write(" && c{0} == 1", j == 14 ? 1 : j);
//    }
...
//for (int i = 1; i <= 13; i++)
//{
//    Console.WriteLine("if (c{0} == 2) twoOfAKindCount++;", i);
//}