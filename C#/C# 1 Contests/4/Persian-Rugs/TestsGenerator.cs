namespace Persian_rug
{
    ...
    public class TestsGenerator
    {
        ...
        public void GenerateTests(string filePath = "../../Tests/")
        {
            ...
            this.sizes = new HashSet<int>() { 3, 5, 6 }; // used for the 0 tests

            this.CreateTest(1, MinSize, 0);
            this.CreateTest(NumTests, MaxSize, Rand.Next(0, MaxSize));
            ...
            for (int i = 2; i <= NumTests - 1; i++)
            {
                ...
                this.CreateTest(i, newSize, Rand.Next(0, MaxSize));
            }
        }
