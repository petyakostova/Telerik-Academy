...
class BitwiseOperators
{
    static void Main()
    {
        ...
        Console.WriteLine(~a);         // 11111111 11111100 = -4 
        ...
        Console.WriteLine(Convert.ToString(bit, 2).PadLeft(32, '0'));    // 00000000000000000000000000000001
        ...
        Console.WriteLine(Convert.ToString(result, 2).PadLeft(32, '0')); // 00000000000000000000000000000011
        ...
        Console.WriteLine(Convert.ToString(result, 2).PadLeft(32, '0')); // 00000000000000000000000000110011
    }
}
