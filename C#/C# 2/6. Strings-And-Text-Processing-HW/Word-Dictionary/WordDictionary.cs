...
using System;
using System.Collections.Generic; // needed for Dictionary<string, string>
...
class WordDictionary
{
    static void Main()
    {
        ...
        /* void Add(K, V) => adds a new pair (key and a value) to the dictionary 
                          => throws an System.ArgumentException if the key exists */
        ...
        /* By default the strings in .NET are case sensitive 
           (the compiler distinguishes uppercase from lowercase letters) */
